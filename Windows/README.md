...
| [OMA-URI/secure-contacts.intune-oma-uri.md](OMA-URI/secure-contacts.intune-oma-uri.md) | Blank OMA-URI row template for manual Intune entry |
| [OMA-URI/secure-contacts.intune-oma-uri.example.md](OMA-URI/secure-contacts.intune-oma-uri.example.md) | Filled OMA-URI reference showing valid sample values |
...
| [OMA-URI/README.intune-omauri-import.md](OMA-URI/README.intune-omauri-import.md) | Quick-start guide for the PowerShell importer |
