...
| [README.Intune-Update-Options-Win.md](README.Intune-Update-Options-Win.md) | Three Windows update paths: Intune-managed GitHub release, packaged-local MSI, and organization-owned Graph publishing |
