...
2. Review the appropriate deployment guide:
   - Windows: [SCA-Intune-Config-Manual-Win.md](Windows/SCA-Intune-Config-Manual-Win.md)
...
4. Deploy the application and configuration through your device management platform.
