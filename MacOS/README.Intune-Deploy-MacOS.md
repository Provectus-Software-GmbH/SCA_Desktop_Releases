...
For configuration policies, see [README.Intune-Config-MacOS.md](README.Intune-Config-MacOS.md). For macOS update options, including administrator-operated AutoPkg and Microsoft Graph automation, see [README.Intune-Update-Options-MacOS.md](README.Intune-Update-Options-MacOS.md). For the Azure DevOps implementation of the organization-owned Graph pipeline, see [README.Intune-Azure-DevOps.md](README.Intune-Azure-DevOps.md).
...
If you do not have a Mac available, use the verified package produced by the repository's AutoPkg workflow instead. See [README.md](README.md).
...
- [README.md](README.md) - AutoPkg staging and package verification
